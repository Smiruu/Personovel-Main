import { INTERACTION_LIST_FAIL, INTERACTION_LIST_REQUEST, INTERACTION_LIST_SUCCESS, INTERACTION_DETAILS_FAIL, INTERACTION_DETAILS_REQUEST, INTERACTION_DETAILS_SUCCESS,  INTERACTION_LIST_BY_BOOK_REQUEST, INTERACTION_LIST_BY_BOOK_SUCCESS, INTERACTION_LIST_BY_BOOK_FAIL  } from "../constants/interactionConstants";
import {
...
export const listInteractionDetails = (id) => async (dispatch) => {
  ...
  export const updateInteraction = (id, formData) => async (dispatch) => {
    ...
    try {
      ...
      const { data } = await instance.put(`api/interactions/${id}/update`, formData, config);
...
export const deleteInteraction = (id) => async (dispatch) => {
    ...
    // Action to reset delete interaction state

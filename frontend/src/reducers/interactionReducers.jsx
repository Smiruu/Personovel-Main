...
import {INTERACTION_CREATE_REQUEST, INTERACTION_CREATE_SUCCESS, INTERACTION_CREATE_FAIL, INTERACTION_CREATE_RESET} from "../constants/interactionConstants";
import {INTERACTION_UPDATE_REQUEST, INTERACTION_UPDATE_SUCCESS, INTERACTION_UPDATE_FAIL, INTERACTION_UPDATE_RESET} from "../constants/interactionConstants";
import {INTERACTION_DELETE_REQUEST, INTERACTION_DELETE_SUCCESS, INTERACTION_DELETE_FAIL, INTERACTION_DELETE_RESET} from "../constants/interactionConstants";
...
export const interactionCreateReducer = (state = { loading: false, success: false, error: null }, action) => {
  switch (action.type) {
...
export const interactionUpdateReducer = (state = { loading: false, success: false, error: null }, action) => {
  switch (action.type) {
...
export const interactionDeleteReducer = (state = { loading: false, success: false, error: null }, action) => {
  switch (action.type) {
